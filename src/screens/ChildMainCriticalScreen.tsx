  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-[#0a0202] flex flex-col items-center">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md mx-auto pt-4 px-4 pb-4 h-[100dvh]">
        ...
        >
          <StatCard title="УЧЁБА" value="3.2" percentage={32} colorHex="#ef4444" colorClass="text-red-500" Icon={BookOpen} />
          <StatCard title="УВАЖЕНИЕ" value="2.5" percentage={25} colorHex="#f97316" colorClass="text-orange-500" Icon={Handshake} />
          <StatCard title="ФОКУС" value="4.1" percentage={41} colorHex="#f43f5e" colorClass="text-rose-500" Icon={Target} />
          <StatCard title="ДОМ" value="1.8" percentage={18} colorHex="#dc2626" colorClass="text-red-600" Icon={Home} />
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col items-center justify-end opacity-40 grayscale">
            ...
            <div className="text-center w-full -mt-4 relative z-20 pointer-events-none">
              ...
              <div className="text-gray-500 font-nunito text-[10px] sm:text-[11px] mb-1">недоступно</div>
          ...
          <div className="flex flex-col items-center justify-end">
            ...
            >
              <img src={dangerImage} alt="Consequences" className="w-[85%] h-auto object-contain drop-shadow-[0_0_35px_rgba(239,68,68,0.5)]" />
            </motion.div>
            <div className="text-center w-full -mt-4 relative z-20 pointer-events-none">
              <div className="text-red-500 font-montserrat font-bold text-[12px] uppercase tracking-wider mb-0.5" style={{ textShadow: '0 0 10px rgba(239,68,68,0.8)' }}>ПОСЛЕДСТВИЯ</div>
              <div className="text-red-400 font-nunito text-[10px] sm:text-[11px] mb-1">ТРЕБУЕТ ВНИМАНИЯ</div>
              <div className="w-[85%] h-1 bg-white/10 rounded-full mx-auto">
                <motion.div 
                  className="h-full bg-red-500 rounded-full shadow-[0_0_10px_rgba(239,68,68,1)]"
                  initial={{ width: "100%" }}
